...
if __name__ == '__main__':
    ...
    parser.add_argument('--rela_path', type=str, default='relative scene data path')
    args = parser.parse_args()
    

    dataset_type = args.data_type
    rela_data_path = args.rela_path
    ...
    if dataset_type == 'private':
        ...
        dir_neuris = '/data/yesheng/3D-Scene/NeuRIS/video_data'
        
        dir_neuris = os.path.abspath(dir_neuris)
        dir_sfm_mvs = os.path.abspath(f'{dir_neuris}/{rela_data_path}')
        
        original_size_img = (1920, 1440)
        cropped_size_img = (640, 480) # cropped images for normal estimation (640, 480)
        reso_level = 1
